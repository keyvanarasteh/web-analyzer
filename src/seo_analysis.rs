...
impl qicro_data_core::registry::Registrable for SeoAnalysisResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("SeoAnalysisResult", "seoanalysisresult")
    }
}

impl qicro_data_core::registry::Registrable for TitleAnalysis {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("TitleAnalysis", "titleanalysis")
    }
}

impl qicro_data_core::registry::Registrable for MetaDescAnalysis {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("MetaDescAnalysis", "metadescanalysis")
    }
}

impl qicro_data_core::registry::Registrable for BasicSeoResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("BasicSeoResult", "basicseoresult")
    }
}

impl qicro_data_core::registry::Registrable for HeadingInfo {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("HeadingInfo", "headinginfo")
    }
}

impl qicro_data_core::registry::Registrable for KeywordInfo {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("KeywordInfo", "keywordinfo")
    }
}

impl qicro_data_core::registry::Registrable for ContentAnalysisResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("ContentAnalysisResult", "contentanalysisresult")
    }
}

impl qicro_data_core::registry::Registrable for TechnicalSeoResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("TechnicalSeoResult", "technicalseoresult")
    }
}

impl qicro_data_core::registry::Registrable for SocialMediaResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("SocialMediaResult", "socialmediaresult")
    }
}

impl qicro_data_core::registry::Registrable for PerformanceResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("PerformanceResult", "performanceresult")
    }
}

impl qicro_data_core::registry::Registrable for AltAttributeResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("AltAttributeResult", "altattributeresult")
    }
}
...
impl qicro_data_core::registry::Registrable for SchemaMarkupResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("SchemaMarkupResult", "schemamarkupresult")
    }
}

impl qicro_data_core::registry::Registrable for LinkAnalysisResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("LinkAnalysisResult", "linkanalysisresult")
    }
}

impl qicro_data_core::registry::Registrable for ImageSeoResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("ImageSeoResult", "imageseoresult")
    }
}

impl qicro_data_core::registry::Registrable for PageSpeedResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("PageSpeedResult", "pagespeedresult")
    }
}

impl qicro_data_core::registry::Registrable for SeoScoreResult {
    fn model_meta() -> qicro_data_core::registry::ModelMeta {
        qicro_data_core::registry::ModelMeta::new("SeoScoreResult", "seoscoreresult")
    }
}
