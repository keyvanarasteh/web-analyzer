...
pub async fn analyze_advanced_seo(
    ...
    if let Some(t) = &progress_tx {
        let _ = t.try_send(crate::ScanProgress {
            module: "SEO Analysis".into(),
            percentage: 5.0,
            message: "Fetching homepage HTML...".into(),
            status: "Info".into(),
        });
    }
    ...
    if let Some(t) = &progress_tx {
        let _ = t.try_send(crate::ScanProgress {
            module: "SEO Analysis".into(),
            percentage: 20.0,
            message: "HTML fetched. Searching for SEO resources (sitemap, robots)...".into(),
            status: "Success".into(),
        });
    }
    ...
    if let Some(t) = &progress_tx {
        let _ = t.try_send(crate::ScanProgress {
            module: "SEO Analysis".into(),
            percentage: 40.0,
            message: "Parsing HTML document...".into(),
            status: "Info".into(),
        });
    }
    ...
    if let Some(t) = &progress_tx {
        let _ = t.try_send(crate::ScanProgress {
            module: "SEO Analysis".into(),
            percentage: 60.0,
            message: "Analyzing Social Media & Analytics...".into(),
            status: "Info".into(),
        });
    }
    ...
    if let Some(t) = &progress_tx {
        let _ = t.try_send(crate::ScanProgress {
            module: "SEO Analysis".into(),
            percentage: 80.0,
            message: "Calculating SEO Core Web Factors...".into(),
            status: "Info".into(),
        });
    }
    ...
    if let Some(t) = &progress_tx {
        let _ = t.try_send(crate::ScanProgress {
            module: "SEO Analysis".into(),
            percentage: 100.0,
            message: "SEO Analysis successfully completed.".into(),
            status: "Success".into(),
        });
    }
